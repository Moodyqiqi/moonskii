...
{
    protected $suffix = '';
    protected $page_title = '后台账户管理';
    protected $page_name = 'accounts';
    protected $view_index = 'account.accounts.index';
    protected $view_show = 'account.accounts.show';
    protected $view_edit = 'account.accounts.edit';
    protected $view_create = 'account.accounts.create';

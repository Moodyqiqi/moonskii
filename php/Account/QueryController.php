...
use App\Model\ChenQuery as Model;
...
class QueryController extends Controller
{
    ...
    protected $page_title = '在线咨询';
    protected $page_name = 'query';
    protected $view_index = 'account.query.index';
    protected $view_show = 'account.query.show';
    protected $view_edit = 'account.query.edit';

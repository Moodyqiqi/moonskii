...
use App\Model\ChenReport as Model;
...
class ReportController extends Controller
{
    ...
    protected $page_title = '信访监督举报';
    protected $page_name = 'report';
    protected $view_index = 'account.report.index';
    protected $view_show = 'account.report.show';
    protected $view_edit = 'account.report.edit';

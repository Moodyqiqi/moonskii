...
use App\Model\Ssjt as Model;
use App\Model\Ssjt;
use Illuminate\Contracts\Encryption\DecryptException;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class SsjtController extends Controller
{
    protected $suffix = '';
    protected $page_title = '集团中心';
    protected $page_name = 'ssjt';
    protected $view_index = 'account.ssjt.index';
    protected $view_show = 'account.ssjt.show';
    protected $view_edit = 'account.ssjt.edit';
    protected $view_create = 'account.ssjt.create';

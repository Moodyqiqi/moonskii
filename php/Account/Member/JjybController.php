...
use App\Model\MemberJjyb as Model;
use App\Model\Ssjt;
...
class JjybController extends Controller
{
    protected $suffix = '_附属单位';
    protected $page_title = '纪检月报';
    protected $page_name = 'member/jjyb';
    protected $view_index = 'account.member.jjyb.index';
    protected $view_show = 'account.member.jjyb.show';
    protected $view_edit = 'account.member.jjyb.edit';
    protected $view_create = 'account.member.jjyb.create';
    protected $view_baobiao = 'account.member.jjyb.baobiao';
    protected $table = 'abel_chen_member_jjyb';

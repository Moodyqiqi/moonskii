...
use App\Model\MemberDanwei as Model;
use App\Model\Ssjt;
use Illuminate\Contracts\Encryption\DecryptException;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class DanweiController extends Controller
{
    protected $suffix = '_附属单位';
    protected $page_title = '单位管理';
    protected $page_name = 'member/danwei';
    protected $view_index = 'account.member.danwei.index';
    protected $view_show = 'account.member.danwei.show';
    protected $view_edit = 'account.member.danwei.edit';
    protected $view_create = 'account.member.danwei.create';

...
class MemberController extends Controller
{
    ...
    protected $page_title = '单位用户管理';
    protected $page_name = 'member/member';
    protected $view_index = 'account.member.member.index';
    protected $view_show = 'account.member.member.show';
    protected $view_edit = 'account.member.member.edit';
    protected $view_create = 'account.member.member.create';
